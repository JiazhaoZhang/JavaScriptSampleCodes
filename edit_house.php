...
<head>
    ...
    <title>Rent Company | Edit House</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
           ...
           <div class="box box-primary">
           		...
           		<div class="box-body">
           			<form method="post" id="ho_form">
           			<div class="row" >
           				<div class="col-md-6">
               				<div class="form-group">
               					<label>House Title : <span style="color: red">*</span></label>
               					<input type="text" class="form-control" name="house_title" id="house_title" data-content="please give the title of your house" data-placement="top" disabled value="<?php echo $data['HO_Title']; ?>" required/>
               				</div>
               				<div class="form-group" id="show_house_type">
               					<label>House Type : </label><span style="color: red">*</span>
               					<p><?php echo $data['HTD_Desc'] ?></p>
               				</div>
               				<div class="form-group" id="edit_house_type" hidden>
               					<label>House Type : </label><span style="color: red">*</span>
               					<select class="form-control" name="house_type" id="house_type" data-content="please give the type of your house" data-placement="top" disabled>
               				...
               				<div class="row">
               					<div class="col-md-4">
                       				<div class="form-group">
                       					...
                       					<input type="text" class="form-control" name="num_bed" id="num_bed" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" data-content="only numbers" data-placement="top" disabled value="<?php echo $data['HO_Beds'];?>"/>
                       				</div>
                   				</div>
                   				<div class="col-md-4">
                       				<div class="form-group">
                       					<label>Number of bathrooms : </label>
                       					<input type="text" class="form-control" name="num_bath" id="num_bath" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" data-content="only numbers" data-placement="top" disabled value="<?php echo $data['HO_Baths'];?>"/>
                       				</div>
                   				</div>
                   				<div class="col-md-4">
                       				<div class="form-group">
                       					<label>Number of Parking : </label>
                       					<input type="text" class="form-control" name="num_park" id="num_park" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" data-content="only numbers" data-placement="top" disabled value="<?php echo $data['HO_Parking'];?>" />
                       				</div>
                   				</div>
                   			</div>
                   			<div class="form-group">
               					<label>Monthly rent: </label>
               					<input type="text" class="form-control" name="house_price" id="house_price" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" data-content="only numbers" data-placement="top" disabled value="<?php echo $data['HO_Price'];?>" />
               				</div>
               				<div class="form-group">
                       			<div class="box-header with-border"><strong>Describe Your House</strong></div>
                       			<div class="box-body">
                       				<textarea class="form-control" rows="5" name="house_desc" id="house_desc" disabled><?php echo $data['HO_Desc'];?></textarea>
                       			</div>
                  			</div>
           				</div>
           				<div class="col-md-6">
               				<div class="form-group">
               					...
               					<input type="text" class="form-control" name="agreement_type" id="agreement_type" disabled value="<?php echo $data['HO_AgreementType'];?>" />
               				</div>
               				<div class="form-group">
               					<label>Move in date</label>
               					<div class="input-group date">
               						<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
               						<input type="text" class="form-control pull-right" name="move_in_date" id="move_in_date" disabled value="<?php echo $data['HO_MoveInDate'];?>" />
               					</div>
               				</div>
               				<div class="form-group">
               					<label>Update house profile</label>
               					<input type="file" class="form-control" name="house_profile" id="house_profile" disabled />
               				</div>
               				<div class="form-group">
               					<label>Update house video</label>
               					<input type="file" class="form-control" name="house_video" id="house_video" disabled />
               				</div><br/>
               				<div class="form-group">
               					<label>Pets friendly &nbsp;</label><input type="checkbox" name="pets_allow" value=1 disabled <?php if($data['HO_PetsAllow']=1){echo 'checked';}?> />
               				</div>
           				</div>
           				<div class="col-md-6" id="edit_ho_div">
							<button class="btn btn-primary col-md-3" id="edit_ho" type="button"> Edit</button>
						</div>
						<div id="save_edit_ho_div" class="col-md-6" hidden>
							<button class="btn btn-success col-md-3" id="submit_ho_edit" type="button">Save</button>&nbsp;&nbsp;&nbsp;
                  			<button class="btn btn-default col-md-3" id="reset_ho_edit" type="reset">Cancel</button>
						</div>
						<div class="col-md-6" style="margin-top: 20px;">
							<a href="#" class="btn btn-info col-md-3"> Preview</a>
						</div>
           			</div>
           			</form>
				</div>
               ...
               <div class="col-md-6">
                   <div class="box box-primary">
                       	...
                       	<div class="box-body">
                           	...
                           	<select class="form-control" id="address_province" data-content="please give the province of your house" data-placement="top" disabled >
							...
							<label>City : </label>
                           	<select class="form-control" id="address_city" data-content="please give the city of your house" data-placement="top" disabled>
                           	</select>
                            <label>Street address : </label>
                            <input type="text" class="form-control" id="address_street" data-content="please give the street of your house" data-placement="top" disabled />
                            <label>Postal code : </label>
                            <input type="text" class="form-control" id="postal_code" data-content="please give the postal code of your house" data-placement="top" disabled />
                       	</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#edit_ho").click(function(){
			$("#save_edit_ho_div").show();
			$("#edit_ho_div").hide();

			$("#edit_house_type").show();
			$("#show_house_type").hide();
			
			$("#ho_form input").removeAttr("disabled");
			$("#ho_form select").removeAttr("disabled");
			$("#ho_form textarea").removeAttr("disabled");
		})
		
		$("#submit_ho_edit").click(function(){
			alert("submit");
			let form = $("#ho_form")[0];
			let form_data = new FormData(form);
			form_data.append("HO_Uuid","<?php echo $data['HO_Uuid']?>");
			 $.ajax({
	            type: "POST",
	            url: "http://localhost/rent_company/Houses/updateHouseOverview/",           
	            data:form_data,
	            cache:false,
	            processData:false,
	            contentType:false, 
		...
		$("#reset_ho_edit").click(function(){
			$("#save_edit_ho_div").hide();
			$("#edit_ho_div").show();

			$("#edit_house_type").hide();
			$("#show_house_type").show();

			$("#ho_form input").attr("disabled","true");
			$("#ho_form select").attr("disabled","true");
			$("#ho_form textarea").attr("disabled","true");
		})
	})
</script>
</body>
